...
async function fetchWeatherData(location) {
    const apiKey = '62496bfac74d40628db103958240709'; // Replace with your API key
...
function getWeatherLogo(tempC) {
    if (tempC <= 0) {
        return 'snowflake.jpg'; // Snowy weather logo
    } else if (tempC <= 15) {
        return 'cloudy.png'; // Cloudy weather logo
    } else if (tempC <= 25) {
        return 'weather1.png'; // Sunny weather logo
    } else {
        return 'sunny.png'; // Hot weather logo
    }
}
